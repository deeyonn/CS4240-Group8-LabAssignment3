...
{
	// UnityEngine.XR.ARFoundation.ARTrackedImageManager PlaceTrackedImages::_ARTrackedImageManager
	ARTrackedImageManager_tCBA77F0B8A7172CC6508CA29176EAE1DE5DC4BD4* ____ARTrackedImageManager_4;
	// UnityEngine.GameObject[] PlaceTrackedImages::_ARTrackedImagePrefabs
	GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* ____ARTrackedImagePrefabs_5;
	// System.Collections.Generic.Dictionary`2<System.String,UnityEngine.GameObject> PlaceTrackedImages::_ARTrackedImagePrefabInstances
	Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* ____ARTrackedImagePrefabInstances_6;
};
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ARTapToPlaceObject_PlaceObject_mCECD0707C6789550497BD4079C19763FB030A1B8 (ARTapToPlaceObject_t608C4C63EACC69846C00DF262C964E81D6DB6994* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_0 = __this->___placementIndicator_4;
...
IL_002e_1:
			{
				...
				// )
				String_t* L_6 = V_2;
				GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_7 = __this->____ARTrackedImagePrefabs_5;
				int32_t L_8 = V_4;
				NullCheck(L_7);
				int32_t L_9 = L_8;
			...
			{
				Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* L_13 = __this->____ARTrackedImagePrefabInstances_6;
				String_t* L_14 = V_2;
				NullCheck(L_13);
				bool L_15;
			...
			}
			{
				...
				// );
				GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_16 = __this->____ARTrackedImagePrefabs_5;
				int32_t L_17 = V_4;
				NullCheck(L_16);
				int32_t L_18 = L_17;
				...
				ARTrackedImage_tC1D6394277D354FB2B952C6D5CAB62140AA455C2* L_29 = V_1;
				NullCheck(L_29);
				...
				Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* L_31 = __this->____ARTrackedImagePrefabInstances_6;
				String_t* L_32 = V_2;
				GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_33 = V_5;
				NullCheck(L_31);
				Dictionary_2_Add_mE5ED48EAB67073C645CD87B5E6ACA2E6BF7975AF(L_31, L_32, L_33, Dictionary_2_Add_mE5ED48EAB67073C645CD87B5E6ACA2E6BF7975AF_RuntimeMethod_var);
			}
...
IL_009e_1:
			{
				// for (int i = 0; i < _ARTrackedImagePrefabs.Length; i++)
				int32_t L_35 = V_4;
				GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_36 = __this->____ARTrackedImagePrefabs_5;
				NullCheck(L_36);
...
IL_00c6:
	{
		...
		L_38 = ARTrackedImagesChangedEventArgs_get_updated_m0C896E1C21EF35FF4B31B36563838EC2BA3CDFD1_inline((&___0_eventArgs), NULL);
		NullCheck(L_38);
...
IL_00d5_1:
			{
				...
				Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* L_41 = __this->____ARTrackedImagePrefabInstances_6;
				...
				V_3 = L_43;
				String_t* L_44;
				L_44 = XRReferenceImage_get_name_mF1BE1E54AD911D48445B7DDEF2E27EA01E1E73BB_inline((&V_3), NULL);
				NullCheck(L_41);
				GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_45;
				L_45 = Dictionary_2_get_Item_m5A8F8BCAC50C5D5AB2722BBD41A340E4F6E47586(L_41, L_44, Dictionary_2_get_Item_m5A8F8BCAC50C5D5AB2722BBD41A340E4F6E47586_RuntimeMethod_var);
				ARTrackedImage_tC1D6394277D354FB2B952C6D5CAB62140AA455C2* L_46 = V_6;
				NullCheck(L_46);
				int32_t L_47;
				L_47 = ARTrackable_2_get_trackingState_m7A60B7D905DBE9E2541B4087F0E6D56C8E4849CF(L_46, ARTrackable_2_get_trackingState_m7A60B7D905DBE9E2541B4087F0E6D56C8E4849CF_RuntimeMethod_var);
				NullCheck(L_45);
				GameObject_SetActive_m638E92E1E75E519E5B24CF150B08CA8E0CDFAB92(L_45, (bool)((((int32_t)L_47) == ((int32_t)2))? 1 : 0), NULL);
			}
...
IL_0120:
	{
		...
		L_49 = ARTrackedImagesChangedEventArgs_get_removed_m062CBBEF163BEE47A673F7B3BDC0DD1C6EAEA185_inline((&___0_eventArgs), NULL);
		NullCheck(L_49);
...
IL_012f_1:
			{
				...
				Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* L_52 = __this->____ARTrackedImagePrefabInstances_6;
				ARTrackedImage_tC1D6394277D354FB2B952C6D5CAB62140AA455C2* L_53 = V_7;
				NullCheck(L_53);
				XRReferenceImage_tB2544D6E18E55CD44F4EED1B0573A6A7154C1E2F L_54;
				L_54 = ARTrackedImage_get_referenceImage_m7F8C3733154BE3242F82D2C9A7987A8AAC1F3E6B_inline(L_53, NULL);
				V_3 = L_54;
				String_t* L_55;
				L_55 = XRReferenceImage_get_name_mF1BE1E54AD911D48445B7DDEF2E27EA01E1E73BB_inline((&V_3), NULL);
				NullCheck(L_52);
				GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_56;
				L_56 = Dictionary_2_get_Item_m5A8F8BCAC50C5D5AB2722BBD41A340E4F6E47586(L_52, L_55, Dictionary_2_get_Item_m5A8F8BCAC50C5D5AB2722BBD41A340E4F6E47586_RuntimeMethod_var);
				il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
				...
				Dictionary_2_t0B15A60B00EC883D4249611C6C641C7BED5A71CE* L_57 = __this->____ARTrackedImagePrefabInstances_6;
				ARTrackedImage_tC1D6394277D354FB2B952C6D5CAB62140AA455C2* L_58 = V_7;
				NullCheck(L_58);
				...
				V_3 = L_59;
				String_t* L_60;
				L_60 = XRReferenceImage_get_name_mF1BE1E54AD911D48445B7DDEF2E27EA01E1E73BB_inline((&V_3), NULL);
				NullCheck(L_57);
				bool L_61;
				L_61 = Dictionary_2_Remove_mD172B7CDE8C2305E9FB368A39846E3C9B296EE32(L_57, L_60, Dictionary_2_Remove_mD172B7CDE8C2305E9FB368A39846E3C9B296EE32_RuntimeMethod_var);
			}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlaceTrackedImages__ctor_m6ED9F36190AAA71939672E2EA701CDB2FE277260 (PlaceTrackedImages_t9A1BE3CE9F556643A2223A2754D3258B4D288A61* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->____ARTrackedImagePrefabInstances_6 = L_0;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____ARTrackedImagePrefabInstances_6), (void*)L_0);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
...
{
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_1;
		memset((&L_1), 0, sizeof(L_1));
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_1), (45.0f), (30.0f), (15.0f), /*hidden argument*/NULL);
		float L_2;
